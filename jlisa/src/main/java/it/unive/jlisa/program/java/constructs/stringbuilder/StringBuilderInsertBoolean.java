...
public class StringBuilderInsertBoolean extends TernaryExpression implements PluggableStatement {
	...
	public StringBuilderInsertBoolean(
			CFG cfg,
	...
	public static StringBuilderInsertBoolean build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new StringBuilderInsertBoolean(cfg, location, params[0], params[1], params[2]);
	}
