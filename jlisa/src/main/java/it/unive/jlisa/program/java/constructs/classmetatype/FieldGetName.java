...
public class FieldGetName extends it.unive.lisa.program.cfg.statement.UnaryExpression implements PluggableStatement {
	...
	public static FieldGetName build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new FieldGetName(cfg, location, params[0]);
	}
	...
	public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> fwdUnarySemantics(
		...
		AccessChild accessThisFieldName = new AccessChild(new JavaReferenceType(stringType), derefThisField, nameVar,
				getLocation());

		HeapReference ref = new HeapReference(reftype, accessThisFieldName, getLocation());
