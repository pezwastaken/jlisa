...
public class MathClassInitializer extends NativeCFG implements PluggableStatement {
	...
	public static class SystemClInit extends NaryExpression implements PluggableStatement {
		...
		public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> forwardSemanticsAux(
			...
			GlobalVariable idPI = new GlobalVariable(JavaDoubleType.INSTANCE, "java.lang.Math::PI", getLocation());
			GlobalVariable idE = new GlobalVariable(JavaDoubleType.INSTANCE, "java.lang.Math::E", getLocation());
