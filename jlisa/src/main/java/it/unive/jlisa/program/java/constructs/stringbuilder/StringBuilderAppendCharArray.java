...
public class StringBuilderAppendCharArray extends BinaryExpression implements PluggableStatement {
	protected Statement originating;

	public StringBuilderAppendCharArray(
			CFG cfg,
	...
	public static StringBuilderAppendCharArray build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new StringBuilderAppendCharArray(cfg, location, params[0], params[1]);
	}
