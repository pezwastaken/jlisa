...
public class FieldGetModifiers extends it.unive.lisa.program.cfg.statement.UnaryExpression
		implements
		PluggableStatement {
	protected Statement originating;

	public FieldGetModifiers(
			CFG cfg,
	...
	public static FieldGetModifiers build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new FieldGetModifiers(cfg, location, params[0]);
	}
	...
	public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> fwdUnarySemantics(
		...
		return analysis.smallStepSemantics(state, accessThisFieldModifiers, this);
	}
