...
public class FieldGetDeclaringClass extends it.unive.lisa.program.cfg.statement.UnaryExpression
		implements
		PluggableStatement {
	protected Statement originating;

	public FieldGetDeclaringClass(
			CFG cfg,
	...
	public static FieldGetDeclaringClass build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new FieldGetDeclaringClass(cfg, location, params[0]);
	}
